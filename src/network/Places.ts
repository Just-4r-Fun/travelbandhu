...
// Specify the place you want to search for
const query = "Jaipur";

// Make a request to the Unsplash API to search for photos related to the specified place
// axios.get(`${apiUrl}${searchEndpoint}?client_id=${accessKey}&query=${query}`, {
//   params: {
//     query,
//     client_id: accessKey,
//   },
    ...
    results: [
      {
        ...
        user: {
          ...
          links: {
            ...
            portfolio:
              "https://api.unsplash.com/users/soakedinnirvana/portfolio",
            following:
              "https://api.unsplash.com/users/soakedinnirvana/following",
            followers:
              "https://api.unsplash.com/users/soakedinnirvana/followers",
          },
          profile_image: {
            small:
